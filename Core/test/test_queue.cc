...
class Queue : public ::testing::TestWithParam<std::pair<core::Queue<int>, std::vector<int>>>
{

};

//Test case for push and front functions
TEST_P(Queue, PushAndFront) {
...
INSTANTIATE_TEST_SUITE_P(Numbers, Queue,
    testing::Values(
...
INSTANTIATE_TEST_SUITE_P(Numbers, QueueFix,
    testing::Values(
        std::make_pair(core::FixedQueue<int, 4>(), std::vector<int>{1, 4, 5, 123, 20}),
